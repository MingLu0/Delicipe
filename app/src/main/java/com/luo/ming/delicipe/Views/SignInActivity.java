...
public class SignInActivity extends AppCompatActivity implements MainActivityPresenter.View {
    ...
    public static final String MAIN_ACTIVITY_MESSAGE = "package com.luo.ming.delicipe.Views.SignInActivity";
